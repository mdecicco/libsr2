...
namespace sr2 {
    ...
    void srfeUnknownScreen4::method_0x128() {
        Widgets* w = WidgetsInstance;
        w->bluebars_01->method_0x110(0);
        w->bluebars_02->method_0x110(0);
        w->bluebars_03->method_0x110(0);
        w->bluebars_04->method_0x110(0);
        w->bluebars_05->method_0x110(0);
        w->bluebars_06->method_0x110(0);
        w->bluebars_07->method_0x110(0);
        w->bluebars_08->method_0x110(0);
        w->bluebars_09->method_0x110(0);
        w->bluebars_10->method_0x110(0);
        w->bluebars_11->method_0x110(0);

        w->side_anim_begin_top->FUN_001f5db0(3);
        w->side_anim_begin_middle->FUN_001f5db0(3);
        w->side_anim_begin_bottom->FUN_001f5db0(3);
        w->side_anim_loop_top->method_0x110(0);
        w->side_anim_loop_middle->method_0x110(0);
        w->side_anim_loop_bottom->method_0x110(0);
        w->clock_top->method_0x110(0);
    }
    ...
    void srfeUnknownScreen4::initWidgets() {
        ...
        w->master->addToMasterUnk0IfNecessary(0x1392);
        ...
        w->bluebars_timer_01->addListener(w->bluebars_01, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_02->addListener(w->bluebars_02, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_03->addListener(w->bluebars_03, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_04->addListener(w->bluebars_04, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_05->addListener(w->bluebars_05, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_06->addListener(w->bluebars_06, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_07->addListener(w->bluebars_07, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_08->addListener(w->bluebars_08, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_09->addListener(w->bluebars_09, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_10->addListener(w->bluebars_10, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_timer_11->addListener(w->bluebars_11, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->bluebars_01->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);

        // todo: this block doesn't actually exist but I suspect the following block has the effect of
        //       cloning the effects of the above function call onto the other bluebars elements
        w->bluebars_02->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_03->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_04->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_05->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_06->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_07->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_08->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_09->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_10->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->bluebars_11->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        ...
        w->bluebars_table->FUN_001fc9f0(0, 0, { *w->bluebars_11, *w->bluebars_10, *w->bluebars_09, *w->bluebars_08, nullptr });
        ...
        w->select_button_timer->addListener(w->select_button, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->select_button_timer->addListener(w->select_text, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);

        w->back_button_timer->addListener(w->back_button, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->back_button_timer->addListener(w->back_text, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);

        w->select_button->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        ...
        // w->side_anim_begin_top->FUN_001f5da0(15.0f);
        // w->side_anim_begin_middle->FUN_001f5da0(15.0f);
        // w->side_anim_begin_bottom->FUN_001f5da0(15.0f);
        ...
        // w->side_anim_loop_top->FUN_001f5da0(15.0f);
        // w->side_anim_loop_middle->FUN_001f5da0(15.0f);
        // w->side_anim_loop_bottom->FUN_001f5da0(15.0f);

        w->side_anim_begin_top->addListener(w->side_anim_loop_top, WidgetEventType::UNK57, &ui2Widget::method_0x38);
        w->side_anim_begin_middle->addListener(w->side_anim_loop_middle, WidgetEventType::UNK57, &ui2Widget::method_0x38);
        w->side_anim_begin_bottom->addListener(w->side_anim_loop_bottom, WidgetEventType::UNK57, &ui2Widget::method_0x38);

        w->side_anim_begin_top->addListener(w->side_anim_begin_top, WidgetEventType::UNK57, &ui2Widget::method_0x38);
        w->side_anim_begin_middle->addListener(w->side_anim_begin_middle, WidgetEventType::UNK57, &ui2Widget::method_0x38);
        w->side_anim_begin_bottom->addListener(w->side_anim_begin_bottom, WidgetEventType::UNK57, &ui2Widget::method_0x38);

        w->side_anim_begin_top->method_0xb0(WidgetEventType::UNK57, WidgetEventType::UNK7, nullptr);
        w->side_anim_begin_middle->FUN_0020ac08(w->side_anim_begin_top, 2);
        w->side_anim_begin_bottom->FUN_0020ac08(w->side_anim_begin_top, 2);

        w->side_anim_loop_top->method_0xb0(WidgetEventType::UNK57, WidgetEventType::UNK8, nullptr);
        w->side_anim_loop_top->method_0xb0(WidgetEventType::UNK57, WidgetEventType::UNK6, nullptr);
        w->side_anim_loop_middle->FUN_0020ac08(w->side_anim_loop_top, 2);
        w->side_anim_loop_bottom->FUN_0020ac08(w->side_anim_loop_top, 2);

        w->side_anim_begin_top_timer->addListener(w->side_anim_begin_top, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->side_anim_begin_middle_timer->addListener(w->side_anim_begin_middle, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->side_anim_begin_bottom_timer->addListener(w->side_anim_begin_bottom, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);

        w->side_anim_begin_top->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
        w->side_anim_begin_top->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK8, nullptr);
        w->side_anim_begin_middle->FUN_0020ac08(w->side_anim_begin_top, 2);
        w->side_anim_begin_bottom->FUN_0020ac08(w->side_anim_begin_top, 2);
        ...
        w->side_anim_l_snd->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK33, nullptr);
        w->side_anim_begin_top_timer->addListener(w->side_anim_l_snd, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->side_anim_begin_middle_timer->addListener(w->side_anim_l_snd, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->side_anim_begin_bottom_timer->addListener(w->side_anim_l_snd, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        ...
        w->side_anim_r_snd->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK33, nullptr);
        w->side_anim_begin_top_timer->addListener(w->side_anim_r_snd, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->side_anim_begin_middle_timer->addListener(w->side_anim_r_snd, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->side_anim_begin_bottom_timer->addListener(w->side_anim_r_snd, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        ...
        w->clock_top_timer->addListener(w->clock_top, WidgetEventType::TimerFinished, &ui2Widget::method_0x38);
        w->clock_top->method_0xb0(WidgetEventType::TimerFinished, WidgetEventType::UNK6, nullptr);
