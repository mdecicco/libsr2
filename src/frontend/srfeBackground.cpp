...
namespace sr2 {
    u32 srfeBackground::ActiveCount = 0;
    u32 srfeBackground::InitializedCount = 0;
    srfeBackground::Widgets* srfeBackground::WidgetsInstance = nullptr;

    srfeBackground::srfeBackground(const char* name, const WidgetRef<ui2Master>& master) : srui2SRScreen(name, master) {
    ...
    srfeBackground::~srfeBackground() {
        deinitScreen();
        if (m_isActive) ActiveCount--;
    }

    void srfeBackground::setActive(bool p1) {
    ...
    void srfeBackground::initScreen() {
    ...
    void srfeBackground::deinitScreen() {
    ...
    void srfeBackground::method_0x110() {
        if (method_0x118()) {
    ...
    bool srfeBackground::method_0x118() {
        return false;
    }

    bool srfeBackground::method_0x120() {
        return false;
    }

    void srfeBackground::initWidgets() {
